...
titl = tk.Label(
    window, text="Smart College!!", bg="white", fg="red", font=("arial", 27),
)
titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="ATTENDENCE SYSTEM",
    bg="red",
    fg="yellow",
    bd=10,
    font=("arial", 45),
...
ri = Image.open("UI_Image/enrollement.png")
r = ImageTk.PhotoImage(ri)
label1 = Label(window, image=r)
label1.image = r
label1.place(x=100, y=270)

ai = Image.open("UI_Image/view.png")
a = ImageTk.PhotoImage(ai)
label2 = Label(window, image=a)
label2.image = a
label2.place(x=980, y=270)

vi = Image.open("UI_Image/verifcation.jpg")
